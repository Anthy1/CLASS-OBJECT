...
kotak kotakHitam = new kotak();
		...
		
		{
			...
			mhs1.setNama("IRWANTI");
			mhs1.setNim("D0217006");
			mhs1.setAlamat("Sumakuyu");
		...
		//membuat objek kelas dari kelas Node
			...
			//membuat objek dari kelas Stack
				...
				Stack.value[0] = "Yulianti Yusuf";
				Stack.value[1] = "Sukmawati";
				Stack.value[2] = "Mariani";
				Stack.value[3] = "Fitriani";
				Stack.value[4] = "Nurul Fitriani";
				Stack.value[5] = "Nur Asiah";
				Stack.value[6] = "Adnan Shale";
				Stack.value[7] = "ebi";
				Stack.value[8] = "mawan";
				Stack.value[9] = "azhar";
				Stack.value[10] = "Eka";
				Stack.value[11] = "Indah";
				Stack.value[12] = "Damir";
				Stack.value[13] = "Septiana dewi";
